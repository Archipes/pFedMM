...
#     python run_experiment.py cifar100 pFedMM --n_learners $n --n_tasks 100 --n_rounds 200 --bz 128 --lr 0.03 \
...
#     python run_experiment.py cifar100 FedEM --n_learners $n --n_tasks 100 --n_rounds 200 --bz 128 --lr 0.03 \
#     --lr_scheduler multi_step --log_freq 1 --device cuda --optimizer sgd --seed 1234 --verbose 1
# done